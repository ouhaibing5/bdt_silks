...
from bdt_product_mcp.auth import build_auth_headers, build_signature
...
def test_build_signature_matches_sorted_sha1() -> None:
    ...
    user_id = "user"
    dc = "dc"
    api_path = "oms/productPriceDetail/priceQueryListData"
...
def test_build_auth_headers_include_signature() -> None:
    headers = build_auth_headers(
        ...
        third_user_id="uid",
        third_dc="d",
        api_path="oms/supplyProduct/exportPriceData",
